  ...
  portfolio: {
    th: {
      ...
      projects: [
        ...
        {
          projectLabel: "CASE STUDY",
          projectName: "RunAwayTech",
          projectDesc:
            "เว็บไซต์แนะนำบริการของ RunAway Tech — Software House ที่พัฒนาซอฟต์แวร์คุณภาพในราคาเข้าถึงได้ รองรับ 2 ภาษา (TH/EN) พร้อม dark/light mode และ responsive design",
          status: "ใช้งานจริง",
          platform: "Web App",
          type: "web" as const,
    ...
    en: {
      ...
      projects: [
        ...
        },
        {
          ...
          projectName: "RunAwayTech",
          projectDesc:
            "The official website for RunAway Tech — a software house delivering quality software at accessible pricing. Supports bilingual content (TH/EN), dark/light mode, and fully responsive design.",
          status: "Live",
          platform: "Web App",
          type: "web" as const,
          url: "https://runawaytech.vercel.app",
